...
# 3. Linking FB use with self-report{.tabset}
...
# 4. Linking FB use with neural data{.tabset}
...
# 5. Link between neural activation in mentalizing regions and IRI{.tabset}
...
# 6. Link between neural activation in cyberball and NTS{.tabset}
